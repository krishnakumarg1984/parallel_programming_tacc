...
\hbox to 20pt{MPI_Cart_sub (\hss} \\
 ...
 & remain_dims & int & LOGICAL  \\&\hbox to 0pt{\footnotesize\sl the \mpicode{i}-th entry of \mpiarg{remain_dims} specifies whether the \mpicode{i}-th dimension is kept in the subgrid (\mpicode{true}) or is dropped (\mpicode{false})\hss} \\ [+3pt] 
