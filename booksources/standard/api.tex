...
&sources&const~int[]&INTEGER&in\\&\hbox to 0pt{\footnotesize length: \tt\catcode`\_=12 n\hss}\\ [-3pt]
&\hbox to 0pt{\footnotesize\sl array containing the n source nodes for which this process specifies edges\hss}\\
&degrees&const~int[]&INTEGER&in\\&\hbox to 0pt{\footnotesize length: \tt\catcode`\_=12 n\hss}\\ [-3pt]
...
&destinations&const~int[]&INTEGER&in\\&\hbox to 0pt{\footnotesize length: \tt\catcode`\_=12 *\hss}\\ [-3pt]
&\hbox to 0pt{\footnotesize\sl destination nodes for the source nodes in the source node array\hss}\\
&weights&const~int[]&INTEGER&in\\&\hbox to 0pt{\footnotesize length: \tt\catcode`\_=12 *\hss}\\ [-3pt]
