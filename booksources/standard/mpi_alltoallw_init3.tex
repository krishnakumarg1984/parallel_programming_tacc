...
\hbox to 20pt{MPI_Alltoallw_init (\hss} \\
 ...
 & sendcounts & const int[] & INTEGER(*)  & IN \\&\hbox to 0pt{\footnotesize\sl integer array (of length group size) specifying the number of elements to send to each rank\hss} \\ [+3pt] 
 ...
 & recvcounts & const int[] & INTEGER(*)  & IN \\&\hbox to 0pt{\footnotesize\sl integer array (of length group size) specifying the number of elements that can be received from each rank\hss} \\ [+3pt] 
