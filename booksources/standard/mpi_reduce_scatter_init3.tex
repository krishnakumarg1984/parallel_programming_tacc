...
\hbox to 20pt{MPI_Reduce_scatter_init (\hss} \\
 ...
 & recvcounts & const int[] & INTEGER(*)  & IN \\&\hbox to 0pt{\footnotesize\sl non-negative integer array specifying the number of elements in result distributed to each process. This array must be identical on all calling processes.\hss} \\ [+3pt] 
