...
\hbox to 20pt{MPI_Type_create_resized_c (\hss} \\
 & oldtype & MPI_Datatype & TYPE(MPI_Datatype)  & IN \\&\hbox to 0pt{\footnotesize\sl input datatype\hss} \\ 
...
&\hbox to 0pt{\footnotesize\sl new extent of datatype\hss} \\ 
 & newtype & MPI_Datatype* & TYPE(MPI_Datatype)  & OUT \\&\hbox to 0pt{\footnotesize\sl output datatype\hss} \\ 
