...
\hbox to 20pt{MPI_Group_range_excl (\hss} \\
 ...
 & ranges & int[][3] & INTEGER(3, n)  \\&\hbox to 0pt{\footnotesize\sl a one-dimensional array of integer triplets, of the form (first rank, last rank, stride) indicating ranks in \mpiarg{group} of processes to be excluded from the output group \mpiarg{newgroup}\hss} \\ [+3pt] 
