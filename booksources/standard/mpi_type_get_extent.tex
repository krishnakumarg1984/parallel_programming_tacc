...
\hbox to 20pt{MPI_Type_get_extent_c (\hss} \\
...
&\hbox to 0pt{\footnotesize\sl lower bound of datatype\hss} \\ [+3pt] 
 & extent & MPI_Aint* & INTEGER(KIND=MPI_ADDRESS_KIND)  & OUT \\ [-3pt]
(c) & & MPI_Count & \hbox to 0pt {INTEGER(KIND=MPI_COUNT_KIND) \hss} \\ [-3pt]
&\hbox to 0pt{\footnotesize\sl extent of datatype\hss} \\ [+3pt] 
