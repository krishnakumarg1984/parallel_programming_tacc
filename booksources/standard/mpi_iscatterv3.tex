...
\hbox to 20pt{MPI_Iscatterv (\hss} \\
 ...
 & displs & const int[] & INTEGER(*)  & IN \\&\hbox to 0pt{\footnotesize\sl integer array (of length group size). Entry \mpicode{i} specifies the displacement (relative to \mpiarg{sendbuf}) from which to take the outgoing data to process \mpicode{i}\hss} \\ [+3pt] 
