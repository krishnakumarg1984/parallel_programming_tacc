...
\indexmpidef{MPI_Cart_create} the sizes of the processor grid along
...
can be queried with \indexmpidef{MPI_Cart_coords} and
\indexmpidef{MPI_Cart_rank} respectively.
