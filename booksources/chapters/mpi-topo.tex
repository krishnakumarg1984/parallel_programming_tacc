...
\cverbatimsnippet[examples/mpi/c/cart.c]{cartshift}
...
use \indexmpidef{MPI_Dist_graph_neighbors}
and \indexmpidef{MPI_Dist_graph_neighbors_count}.
...
%
\indexmpidef{MPI_Dist_graph_neighbors_count}
and
\indexmpidef{MPI_Dist_graph_neighbors}.

While this information seems derivable from the graph construction,
that is not entirely true for two reasons.
\begin{enumerate}
\item With the non-adjoint version \indexmpishow{MPI_Dist_graph_create},
