...
\fverbatimsnippet[examples/mpi/f/contiguous.F90]{contiguous-f}
...
\begin{mplnote}{Contiguous composing}
  ...
  %
  (Contrast this with \indexmpldef{strided_vector_layout}; note~\ref{mpl:strided_vector}.)
\end{mplnote}
...
\begin{mplnote}{Vector type}
  ...
  MPL uses the \indexmpldef{strided_vector_layout} class:
  %
  \cxxverbatimsnippet[examples/mpi/mpl/vector.cxx]{vectormpl}
