...
\n{mpiexec} program, and appears on the interactive console.
...
thousand nodes in your cluster, \n{mpiexec} can start your program once
...
\Level 1 {C}
\index{C!MPI bindigs|see{MPI, C bindings}}
...
\begin{mpifour}
  ...
  This requires including \indextermttdef{mpi.hpp}:
\begin{verbatim}
#include <mpi.hpp>
\end{verbatim}
  rather than \indextermtt{mpi.h}.
\end{mpifour}
