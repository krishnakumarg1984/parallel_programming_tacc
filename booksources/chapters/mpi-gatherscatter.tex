...
\begin{mplnote}{Gather on non-root}
  Logically speaking, on every non-root process,
...
\begin{exercise}
  ...
  two distributed vectors. Hint: look up \indexterm{bucket brigade};
  section~\ref algorithm'. What is the time and space complexity
