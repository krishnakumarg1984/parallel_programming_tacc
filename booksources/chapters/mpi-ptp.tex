...
\begin{itemize}
\item \indexmpiref{MPI_ERROR} gives the error status of the receive call;
  see section~\ref{sec:mpi-status-error}.
\item \indexmpiref{MPI_SOURCE} gives the source of the message;
  see section~\ref{sec:mpi-source}.
\item \indexmpiref{MPI_TAG} gives the tag with which the message was received;
