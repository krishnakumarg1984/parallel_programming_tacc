...
\begin{pythonnote}{Buffers from numpy}
  Most MPI routines in Python have both a native and a numpy variant.
  The native variant looks the most `pythonic', and is very flexible,
