...
\Level 1 {Non-blocking read/write}
...
There are also \indextermsub{split}{collective} routines
...
Also \indexmpidef{MPI_File_iread_shared}, \indexmpidef{MPI_File_iwrite_shared}.
