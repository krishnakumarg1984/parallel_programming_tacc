...
\begin{exercise}
  ...
  behaviour using timings, for instance running it on an increasing number of processes?
  \exercisesource{rightsend}
\end{exercise}
...
value of \indexmpidef{MPI_PROC_NULL} for
