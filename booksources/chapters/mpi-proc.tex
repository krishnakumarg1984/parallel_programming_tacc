...
\cxxverbatimsnippet[code/mpi/c/portapp.c]{mpiportmanage}
...
\cxxverbatimsnippet[code/mpi/c/portapp.c]{mpiportwork}
...
or from a session and from \indexmpishow{MPI_Comm_get_parent} or \indexmpishow{MPI_Comm_join}.
