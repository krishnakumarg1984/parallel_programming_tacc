...
but this is deprecated as of \indextermsub{Numpy}{1.20}
...
See also the \indexmpidef{MPI_Sizeof}
...
Fortran lacks a \indextermtt{sizeof} operator to query the sizes of datatypes.
Since sometimes exact byte counts are necessary,
for instance in one-sided communication,
Fortran can use the (deprecated) \indexmpidef{MPI_Sizeof} routine.
