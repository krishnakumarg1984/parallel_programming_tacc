...
\indexmpishow{MPI_Irecv}, you seen that non-blocking routine yields
...
\begin{mplnote}{Requests from non-blocking calls}
  ...
  is a function result, not a parameter passed by reference,
...
%
\cverbatimsnippet[examples/mpi/c/irecvsource.c]{waitforany}
%
