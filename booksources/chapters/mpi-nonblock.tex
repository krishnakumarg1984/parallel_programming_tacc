...
\begin{mplnote}{Requests from non-blocking calls}
  \label{mpl:irequest}
  Non-blocking routines have an \indexmpldef{irequest} as function result.
...
\begin{exercise}
  ...
  \exercisesource{bucketpipenonblock}
\end{exercise}
...
\begin{exercise}
  ...
  \exercisesource{isendirecvarray}
