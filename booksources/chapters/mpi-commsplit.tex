...
\begin{pythonnote}{Comm split key is optional}
  ...
  %
  \pverbatimsnippet[examples/mpi/p/commsplit.py]{commsplitp}
\end{pythonnote}
...
\begin{mplnote}{Communicator splitting}
  ...
  \begin{mplimpl}
    The \lstinline+communicator::+\indexmpldef{split} identifier itself is an otherwise empty
