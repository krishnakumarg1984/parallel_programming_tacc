...
\begin{itemize}
\item \indexompdef{omp_set_num_threads}
\item \indexompdef{omp_get_num_threads}
\item \indexompdef{omp_get_max_threads}
\item \indexompdef{omp_get_thread_num}
\item \indexompdef{omp_get_num_procs}
\item \indexompdef{omp_in_parallel}
\item \indexompdef{omp_set_dynamic}
\item \indexompdef{omp_get_dynamic}
\item \indexompdef{omp_set_nested}
\item \indexompdef{omp_get_nested}
\item \indexompdef{omp_get_wtime}
\item \indexompdef{omp_get_wtick}
\item \indexompdef{omp_set_schedule}
\item \indexompdef{omp_get_schedule}
\item \indexompdef{omp_set_max_active_levels}
\item \indexompdef{omp_get_max_active_levels}
\item \indexompdef{omp_get_thread_limit}
\item \indexompdef{omp_get_level}
\item \indexompdef{omp_get_active_level}
\item \indexompdef{omp_get_ancestor_thread_num}
\item \indexompdef{omp_get_team_size}
%\item \indexompdef{omp_}
\end{itemize}

Here are the OpenMP \emph{environment variables}:
\begin{itemize}
\item \indexompdef{OMP_CANCELLATION} Set whether cancellation is activated
...
\item \indexompdef{OMP_MAX_ACTIVE_LEVELS} Set the maximum number of nested parallel
  regions
\item \indexompdef{OMP_MAX_TASK_PRIORITY} Set the maximum task priority value
...
\item \indexompdef{OMP_PROC_BIND} Whether theads may be moved between CPUs
\item \indexompdef{OMP_PLACES} Specifies on which CPUs the theads should be placed
\item \indexompdef{OMP_STACKSIZE} Set default thread stack size
\item \indexompdef{OMP_SCHEDULE} How threads are scheduled
\item \indexompdef{OMP_THREAD_LIMIT} Set the maximum number of threads
...
\cverbatimsnippet[examples/omp/c/link.c]{linkedlist}
