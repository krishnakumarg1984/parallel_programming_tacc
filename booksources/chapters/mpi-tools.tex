...
\end{lstlisting}
The handle value of \indexmpidef{MPI_T_PVAR_ALL_HANDLES} is allowed.
...
\begin{raggedlist}
  ...
  \indexmpidef{MPI_T_cvar_get_info},
  \indexmpidef{MPI_T_pvar_get_info},
  \indexmpidef{MPI_T_category_get_info}.
\end{raggedlist}
