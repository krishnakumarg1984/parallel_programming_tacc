...
%%     {fortrannote}
%%     {\par\advance\leftskip by \unitindent
%%       \refstepcounter{fortrannote}
%%       \noindent \hbox
%%                 {\kern-\unitindent \textsl{Fortran note \arabic{fortrannote}:\ \CommentArg.}}\ %
%%       \addcontentsline{loftn}{fortrannote}{\protect\numberline{\thefortrannote}\CommentArg}
%%       %\index[fortran]{\CommentArg}%
...
%%     {pythonnote}
%%     {\par\advance\leftskip by \unitindent
%%       \refstepcounter{pythonnote}
%%       \noindent \hbox{\kern-\unitindent \textsl{Python note \arabic{pythonnote}:\ \CommentArg.}}\ %
%%       \addcontentsline{lopy}{pythonnote}{\protect\numberline{\thepythonnote}\CommentArg}
