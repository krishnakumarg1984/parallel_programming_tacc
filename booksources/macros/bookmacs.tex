...
%%   {\begin{specialnote}{Python note}\index[python]{#1}}
%%   {\end{specialnote}}
\argcomment
    {pythonnote}
...
\newenvironment{taccnote}
  ...
  {\end{specialnote}}
\makeindex[name=mpl]
%% \newenvironment{mplnote}[1]
%%   {\begin{specialnote}{MPL note}\index[mpl]{#1}}
%%   {\end{specialnote}}
...
\argcomment
    {mplnote}
    {\stepcounter{mplnote}
      %\def\CommentCutFile{snippets/mplnote\arabic{mplnote}.out}
