...
\newcommand\PackageIndex[1]{\begingroup
    \InnocentChars \ShowRoutinetrue
    \afterassignment#1\edef\indexedroutine
}
...
{ \catcode`\_=13
  \gdef\RoutineRefDisplay{%
    \begin{manpage}
      ...
      \else
          {\par \large \ref{\labeltext}\ \textbf{\texttt{\referencedroutine}}}
      \fi
      {\large \ref{\labeltext}\ \textbf{\texttt{\indexedroutine}}}
      % routine
      {\footnotesize \edef\tmp{\noexpand\verbatiminput{\referencedroutine}}\tmp }
      %\caption{}
