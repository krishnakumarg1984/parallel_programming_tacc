...
\makeindex
\makeindex[name=mpi]
% already elsewhere? \makeindex[name=mpl]
\makeindex[name=sycl]
\makeindex[name=omp]
    ...
    \begin{manpage}%
      ...
      {\footnotesize
        ...
        \ifx\mpifam\routinefam
            ...
            \IfFileExists{mplreference/\referencedroutine}
                  {\edef\tmp{\noexpand\verbatiminput{mplreference/\referencedroutine}}\tmp}{}
            \IfFileExists{pyreference/\referencedroutine}
                  {\verbatiminput{pyreference/\referencedroutine}}{}
        \else
