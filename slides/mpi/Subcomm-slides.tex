...
\frame[containsverbatim]{\frametitle{Interleaved library and user code}
  \cxxverbatimsnippet{catchmain}
}
\frame[containsverbatim]{\frametitle{Library internally has messages}
  \cxxverbatimsnippet{catchcalls}
}
\frame[containsverbatim]{\frametitle{Wrong way of setting up the library}
  \cxxverbatimsnippet{wrongcatchlib}
}

\frame[containsverbatim]{\frametitle{Right way of setting up the library}
